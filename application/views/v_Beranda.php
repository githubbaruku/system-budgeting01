...
$Keluar = 0;
if ($g !== null && isset($g['saldo_awal'], $g['kas_masuk'], $g['kas_keluar'])) {
...
<span class="info-box-number"><small><?php echo isset($g['saldo_awal']) ? rupiah($g['saldo_awal']) : ''; ?></small></span>
...
<div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box">
        ...
        <div class="info-box-content">
            ...
            <span class="info-box-number"><small><?php echo isset($g['kas_masuk']) ? rupiah($g['kas_masuk']) : ''; ?></small></span>
...
<div class="col-md-3 col-sm-6 col-xs-12">
	<div class="info-box">
        ...
        <div class="info-box-content">
            ...
            <span class="info-box-number"><small><?php echo isset($g['kas_keluar']) ? rupiah($g['kas_keluar']) : ''; ?></small></span>
    ...
    <div class="box box-primary">
        ...
        <div class="box-body text-center">
            <div class="jumbotron jumbotron-fluid" style="background-color:white;">
                <div class="container">
                 	<img style="width: 15%" src="<?=base_url('assets/dist/img/stmik.jpg')?>">
                    <h2 class="display-4" style="color:#0066ff;">SISTEM BUDGETING</h2>
                    <p class="lead" style="color:#66a3ff ">STMIK ANTAR BANGSA</p>
                </div>
            </div>
